...
export default function StickyWhatsApp() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2 bg-brick text-mist rounded-full pl-4 pr-5 py-3 shadow-soft hover:bg-brick/90 transition-colors"
