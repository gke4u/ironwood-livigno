...
export default function StickyWhatsApp() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-1.5 bg-[#25D366] text-white rounded-full pl-3 pr-4 py-2.5 shadow-soft hover:bg-[#20bd5a] transition-colors"
    ...
    >
      ...
      <span className="text-sm font-medium">{tc('whatsapp_cta')}</span>
    </a>
  );
}
