...
export const landingPageTranslations: Record<string, Partial<Record<TranslatedLandingLocale, LandingTranslation>>> = {
  ...
  benessere: {
    ...
    da: {
      ...
      metaTitle: 'Privat sauna i Livigno | Dampbad og velvære i lejligheden',
      metaDescription: 'Privat infrarød sauna og dampbad, aldrig delt med andre gæster: oplev velværesiden af et ophold i Livigno hos Ironwood.',
      eyebrow: 'Velvære',
      intro:
        'Efter en dag på ski eller på stierne betyder måden, du restituerer på, lige så meget som selve aktiviteten. Hos Ironwood Livigno er den infrarøde sauna og dampbadet ikke en delt service i et fælles rum: de er private, inde i lejligheden, kun til rådighed for dem, der bor her.',
      sections: [
        {
          heading: 'Hvorfor en privat sauna gør en forskel',
          body: [
            'På mange bjergindkvarteringer er sauna og dampbad fælles rum med bookingtider, håndklæder man selv skal medbringe, og en reel risiko for at skulle dele dem med fremmede. Hos Ironwood i Livigno er den infrarøde sauna og dampbadet derimod forbeholdt udelukkende lejlighedens gæster: ingen ventetid, ingen booking, ingen deling — på ethvert tidspunkt af dagen eller aftenen.',
            'Den infrarøde sauna er især velegnet til muskelrestitution: varmen trænger dybt ind i vævet, en konkret hjælp efter en dag med ski, vandreture eller mountainbike, når ben og ryg trænger til at blive løsnet, endnu inden man sætter sig til aftensmad.'
          ]
        },
        {
          heading: 'Et enkelt ritual, der kan gentages hver dag',
          body: [
            'Fordelen ved at have sauna og dampbad derhjemme frem for i et delt spa er friheden til at gøre det til en daglig vane på ferien: man kommer hjem fra pisterne eller stien, varmer op i ro og mag, måske med et glas vin fra køkkenet, og først derefter tænker man på aftensmaden. Ingen tidsplan at følge, ingen app til at booke en tid.',
            'Stuen, med sin elektriske pejs, fuldender billedet: aftenerne i lejligheden bliver en lige så stor del af oplevelsen som dagen på pisterne eller stierne — ikke bare et sted at sove.'
          ]
        },
        {
          heading: 'En detalje gæsterne virkelig bemærker',
          body: [
            'Det er ikke bare en markedsføringstekst: det er en af de detaljer, der oftest nævnes i de rigtige anmeldelser, vi modtager på Google og Airbnb, ofte beskrevet som en af hovedgrundene til at vælge Ironwood frem for et traditionelt hotel. Og for dem, der vil fuldende oplevelsen med en gennemtænkt morgenmad, inden de tager afsted, tilbyder vi også en betalt morgenmadsservice efter ønske, hos et samarbejdssted få meter fra lejligheden.'
          ]
        }
      ],
      highlights: [
        'Privat infrarød sauna og dampbad, aldrig delt',
        'Ingen booking nødvendig, tilgængelig når som helst på dagen',
        'Elektrisk pejs i stuen til aftenerne',
        'Morgenmad efter ønske få meter fra lejligheden'
      ],
    ...
    pl: {
      ...
      eyebrow: 'Wellness',
      intro:
        'Po dniu spędzonym na nartach lub szlakach sposób, w jaki się regenerujesz, liczy się tak samo jak sama aktywność. W Ironwood Livigno sauna na podczerwień i łaźnia parowa nie są usługą współdzieloną w przestrzeni wspólnej: są prywatne, wewnątrz apartamentu, dostępne wyłącznie dla osób tu mieszkających.',
      sections: [
        {
          heading: 'Dlaczego prywatna sauna robi różnicę',
          body: [
            'W wielu górskich obiektach sauna i łaźnia parowa to przestrzenie wspólne, z godzinami rezerwacji, szlafrokami do przyniesienia i realną możliwością dzielenia ich z nieznajomymi. W Ironwood w Livigno sauna na podczerwień i łaźnia parowa są natomiast zarezerwowane wyłącznie dla gości apartamentu: bez oczekiwania, bez rezerwacji, bez dzielenia — o każdej porze dnia i wieczoru.',
            'Sauna na podczerwień jest szczególnie wskazana do regeneracji mięśni: ciepło przenika głęboko w tkanki, co stanowi realną pomoc po dniu jazdy na nartach, trekkingu czy jazdy na rowerze górskim, gdy nogi i plecy domagają się rozluźnienia, jeszcze zanim usiądziesz do kolacji.'
          ]
        },
        {
          heading: 'Prosty rytuał, powtarzalny każdego dnia',
          body: [
            'Zaletą posiadania sauny i łaźni parowej we własnym apartamencie, zamiast we wspólnym spa, jest wolność uczynienia z tego codziennego nawyku wakacji: wraca się ze stoku lub szlaku, spokojnie się rozgrzewa, może z kieliszkiem wina z kuchennej lodówki na wino, i dopiero potem myśli się o kolacji. Żadnego harmonogramu do przestrzegania, żadnej aplikacji do rezerwowania terminu.',
            'Salon z elektrycznym kominkiem dopełnia obrazu: wieczory w apartamencie stają się częścią doświadczenia w takim samym stopniu jak dzień na stokach czy szlakach, a nie tylko miejscem do spania.'
          ]
        },
        {
          heading: 'Plus, który goście naprawdę zauważają',
          body: [
            'To nie tylko opis marketingowy: to jeden ze szczegółów najczęściej wymienianych w prawdziwych opiniach, które otrzymujemy na Google i Airbnb, często opisywany jako jeden z głównych powodów wyboru Ironwood zamiast tradycyjnego hotelu. A dla tych, którzy chcą uzupełnić doświadczenie starannie przygotowanym śniadaniem przed wyjściem, oferujemy również usługę śniadaniową na życzenie, odpłatnie, w partnerskim obiekcie kilka metrów od apartamentu.'
          ]
        }
      ],
      highlights: [
        'Prywatna sauna na podczerwień i łaźnia parowa, nigdy niedzielone',
        'Bez rezerwacji, dostępne o każdej porze dnia',
        'Elektryczny kominek w salonie na wieczory',
        'Śniadanie na życzenie kilka metrów od apartamentu'
      ],
    ...
    cs: {
      ...
      eyebrow: 'Wellness',
      intro:
        'Po dni na lyžích nebo na stezkách záleží na tom, jak regenerujete, stejně jako na samotné aktivitě. V Ironwood Livigno nejsou infrasauna a parní lázeň sdílenou službou ve společném prostoru: jsou soukromé, uvnitř apartmánu, k dispozici pouze těm, kdo zde bydlí.',
      sections: [
        {
          heading: 'Proč soukromá sauna dělá rozdíl',
          body: [
            'V mnoha horských ubytováních jsou sauna a parní lázeň společné prostory, s rezervačními časy, županem, který je třeba přinést, a reálnou možností, že je budete muset sdílet s cizími lidmi. V Ironwood v Livignu jsou naopak infrasauna a parní lázeň vyhrazeny výhradně hostům apartmánu: žádné čekání, žádná rezervace, žádné sdílení — v kteroukoli denní či večerní hodinu.',
            'Infrasauna je obzvláště vhodná pro regeneraci svalů: teplo proniká hluboko do tkání, což je konkrétní pomoc po dni lyžování, treku nebo jízdy na horském kole, kdy nohy a záda potřebují uvolnit ještě předtím, než usednete k večeři.'
          ]
        },
        {
          heading: 'Jednoduchý rituál, opakovatelný každý den',
          body: [
            'Výhodou vlastní sauny a parní lázně doma místo sdíleného spa je svoboda udělat si z toho denní zvyk dovolené: vrátíte se ze sjezdovky nebo ze stezky, v klidu se zahřejete, třeba se sklenkou vína z kuchyňské vinotéky, a teprve pak myslíte na večeři. Žádný rozvrh, který je třeba dodržet, žádná aplikace pro rezervaci termínu.',
            'Obývací pokoj s elektrickým krbem dotváří celkový obraz: večery v apartmánu se stávají stejnou součástí zážitku jako den na sjezdovkách nebo stezkách, nejen místem ke spaní.'
          ]
        },
        {
          heading: 'Plus, kterého si hosté opravdu všímají',
          body: [
            'Není to jen marketingový popis: je to jeden z detailů nejčastěji zmiňovaných ve skutečných recenzích, které dostáváme na Google a Airbnb, často popisovaný jako jeden z hlavních důvodů, proč zvolit Ironwood místo tradičního hotelu. A pro ty, kdo chtějí zážitek doplnit o pečlivě připravenou snídani před odchodem, nabízíme také placenou snídaňovou službu na přání, ve smluvním zařízení pár metrů od apartmánu.'
          ]
        }
      ],
      highlights: [
        'Soukromá infrasauna a parní lázeň, nikdy sdílené',
        'Žádná rezervace, dostupné kdykoli během dne',
        'Elektrický krb v obývacím pokoji pro večery',
        'Snídaně na přání pár metrů od apartmánu'
      ],
    ...
    no: {
      ...
      metaTitle: 'Privat badstue i Livigno | Dampbad og velvære i leiligheten',
      metaDescription: 'Privat infrarød badstue og dampbad, aldri delt med andre gjester: oppdag velværesiden ved et opphold i Livigno hos Ironwood.',
      eyebrow: 'Velvære',
      intro:
        'Etter en dag på ski eller på stiene betyr måten du restituerer på like mye som selve aktiviteten. Hos Ironwood Livigno er den infrarøde badstuen og dampbadet ikke en delt tjeneste i et fellesrom: de er private, inne i leiligheten, kun tilgjengelig for dem som bor her.',
      sections: [
        {
          heading: 'Hvorfor en privat badstue utgjør en forskjell',
          body: [
            'På mange fjellovernattinger er badstue og dampbad fellesrom, med bookingtider, badekåper man må ta med selv, og en reell mulighet for å måtte dele dem med fremmede. Hos Ironwood i Livigno er den infrarøde badstuen og dampbadet derimot forbeholdt utelukkende leilighetens gjester: ingen venting, ingen booking, ingen deling — til enhver tid på dagen eller kvelden.',
            'Den infrarøde badstuen er spesielt egnet for muskelrestitusjon: varmen trenger dypt inn i vevet, en konkret hjelp etter en dag med ski, fotturer eller fjellsykling, når ben og rygg trenger å løsnes opp allerede før du setter deg til middag.'
          ]
        },
        {
          heading: 'Et enkelt ritual, som kan gjentas hver dag',
          body: [
            'Fordelen ved å ha badstue og dampbad hjemme, i stedet for i et delt spa, er friheten til å gjøre det til en daglig vane på ferien: du kommer hjem fra bakkene eller stien, varmer opp i ro og mak, kanskje med et glass vin fra kjøkkenet, og først deretter tenker du på middag. Ingen timeplan å følge, ingen app for å booke en time.',
            'Stuen, med sin elektriske peis, fullender bildet: kveldene i leiligheten blir like mye en del av opplevelsen som dagen i bakkene eller på stiene — ikke bare et sted å sove.'
          ]
        },
        {
          heading: 'En detalj gjestene virkelig legger merke til',
          body: [
            'Det er ikke bare en markedsføringstekst: det er en av detaljene som oftest nevnes i de ekte anmeldelsene vi mottar på Google og Airbnb, ofte beskrevet som en av hovedgrunnene til å velge Ironwood fremfor et tradisjonelt hotell. Og for dem som vil fullende opplevelsen med en gjennomtenkt frokost før de drar ut, tilbyr vi også en betalt frokosttjeneste på forespørsel, hos et samarbeidssted få meter fra leiligheten.'
          ]
        }
      ],
      highlights: [
        'Privat infrarød badstue og dampbad, aldri delt',
        'Ingen booking nødvendig, tilgjengelig når som helst på dagen',
        'Elektrisk peis i stuen for kveldene',
        'Frokost på forespørsel få meter fra leiligheten'
      ],
    ...
    nl: {
      ...
      eyebrow: 'Wellness',
      intro:
        "Na een dag op de ski's of op de paden telt de manier waarop je herstelt net zo zwaar als de activiteit zelf. Bij Ironwood Livigno zijn de infraroodsauna en het stoombad geen gedeelde voorziening in een gemeenschappelijke ruimte: ze zijn privé, in het appartement zelf, alleen beschikbaar voor wie hier verblijft.",
      sections: [
        {
          heading: 'Waarom een privésauna het verschil maakt',
          body: [
            'Bij veel accommodaties in de bergen zijn sauna en stoombad gedeelde ruimtes, met boekingstijden, badjassen die je zelf moet meenemen en de reële kans dat je ze met vreemden moet delen. Bij Ironwood in Livigno zijn de infraroodsauna en het stoombad daarentegen uitsluitend voorbehouden aan de gasten van het appartement: geen wachten, geen reservering, geen delen — op elk moment van de dag of avond.',
            'Vooral de infraroodsauna is geschikt voor spierherstel: de warmte dringt diep in het weefsel door, een echte hulp na een dag skiën, wandelen of mountainbiken, wanneer benen en rug om ontspanning vragen nog voordat je aan tafel gaat voor het avondeten.'
          ]
        },
        {
          heading: 'Een eenvoudig ritueel, elke dag te herhalen',
          body: [
            "Het voordeel van een sauna en stoombad thuis, in plaats van in een gedeelde spa, is de vrijheid om er een dagelijkse gewoonte van de vakantie van te maken: je komt terug van de piste of het pad, warmt rustig op, misschien met een glas wijn uit de keuken, en denkt pas daarna aan het avondeten. Geen rooster om te volgen, geen app om een tijdslot te boeken.",
            'De woonkamer, met zijn elektrische open haard, maakt het plaatje compleet: de avonden in het appartement worden net zo goed onderdeel van de ervaring als de dag op de piste of de paden, niet zomaar een plek om te slapen.'
          ]
        },
        {
          heading: 'Een detail dat gasten echt opmerken',
          body: [
            'Het is niet zomaar marketingtaal: het is een van de details die het vaakst worden genoemd in de echte recensies die we op Google en Airbnb ontvangen, vaak omschreven als een van de belangrijkste redenen om voor Ironwood te kiezen in plaats van een traditioneel hotel. En voor wie de ervaring wil aanvullen met een verzorgd ontbijt voordat je erop uit trekt, bieden we ook een betaald ontbijtservice op aanvraag, bij een partneraccommodatie op een paar meter van het appartement.'
          ]
        }
      ],
      highlights: [
        'Privé infraroodsauna en stoombad, nooit gedeeld',
        'Geen reservering nodig, op elk moment van de dag beschikbaar',
        'Elektrische open haard in de woonkamer voor de avonden',
        'Ontbijt op aanvraag op een paar meter van het appartement'
      ],
    ...
    zh: {
      ...
      metaTitle: '利维尼奥私人桑拿 | 公寓内的土耳其蒸汽浴与养生体验',
      metaDescription: '私人红外线桑拿与土耳其蒸汽浴,绝不与其他客人共用:探索在Ironwood利维尼奥入住的养生一面。',
      eyebrow: '养生',
      intro:
        '滑雪或徒步一天之后,恢复的方式与活动本身同样重要。在Ironwood Livigno,红外线桑拿和土耳其蒸汽浴并非公共空间中的共享服务,而是私属于公寓内部,只供入住客人使用。',
      sections: [
        {
          heading: '私人桑拿为何与众不同',
          body: [
            '在许多山区住宿中,桑拿和蒸汽浴是共用空间,需要预约时段、自带浴袍,还可能与陌生人共用。而在利维尼奥的Ironwood,红外线桑拿和土耳其蒸汽浴则专属于公寓客人:无需等待、无需预约、无需与人共享——一天中的任何时刻皆可使用。',
            '红外线桑拿尤其适合肌肉恢复:热量深入渗透组织,在滑雪、徒步或山地自行车一天之后,当双腿和后背在坐下吃晚餐前就渴望舒展时,能带来切实的帮助。'
          ]
        },
        {
          heading: '简单的仪式,每天皆可重复',
          body: [
            '在家中拥有桑拿和蒸汽浴,而非在共用水疗中心使用,其优势在于可以自由地将其变成假期的日常习惯:从雪道或步道归来,从容地暖身,或许再从厨房的酒柜里倒一杯红酒,之后才考虑晚餐。没有时刻表要遵守,也无需用App预约时段。',
            '带电壁炉的客厅让整个体验更加完整:公寓里的夜晚成为体验的一部分,与雪道或步道上的白天同样重要,而不仅仅是一个睡觉的地方。'
          ]
        },
        {
          heading: '客人真正会留意到的加分项',
          body: [
            '这不只是营销宣传:这是我们在Google和Airbnb收到的真实评价中最常被提及的细节之一,常被描述为选择Ironwood而非传统酒店的主要原因之一。对于想在出门前享用一顿精心准备的早餐来完善体验的客人,我们还可应要求提供付费早餐服务,地点位于距公寓仅几米的合作场所。'
          ]
        }
      ],
      highlights: [
    ...
    ja: {
      ...
      metaTitle: 'リヴィニョの専用サウナ | アパートメント内のスチームバスとウェルネス',
      metaDescription: '専用の赤外線サウナとスチームバス、他の宿泊客とは決して共有しません。Ironwoodでのリヴィニョ滞在のウェルネスな一面をご紹介します。',
      eyebrow: 'ウェルネス',
      intro:
        'スキーやトレイルでの一日を終えたあと、どのように回復するかは、アクティビティそのものと同じくらい重要です。Ironwood Livignoでは、赤外線サウナとスチームバスは共用スペースで提供されるサービスではありません。アパートメント内にある専用設備で、ここにご滞在の方だけがご利用いただけます。',
      sections: [
        {
          heading: '専用サウナが違いを生む理由',
          body: [
            '多くの山岳リゾートでは、サウナやスチームバスは共用スペースにあり、予約時間があったり、バスローブを持参する必要があったり、見知らぬ人と共有しなければならない可能性も実際にあります。一方、リヴィニョのIronwoodでは、赤外線サウナとスチームバスはアパートメントの宿泊客専用です。待ち時間も、予約も、共有もなく、昼夜を問わずいつでもご利用いただけます。',
            '特に赤外線サウナは筋肉の回復に適しており、熱が組織の深部まで浸透します。スキー、トレッキング、マウンテンバイクを楽しんだ一日のあと、夕食の席に着く前に脚や背中をほぐしたいときに、実感できる助けとなります。'
          ]
        },
        {
          heading: 'シンプルで、毎日繰り返せる習慣',
          body: [
            '共用スパではなく自宅にサウナとスチームバスがあることの利点は、それを休暇中の毎日の習慣にできる自由さです。ゲレンデやトレイルから戻り、キッチンのワインセラーからグラス一杯のワインを片手にゆっくりと体を温め、それから夕食のことを考える。決められたスケジュールも、予約用のアプリも必要ありません。',
            '電気暖炉のあるリビングルームがその体験を完成させます。アパートメントでの夜は、ゲレンデやトレイルでの一日と同じくらい体験の一部となり、単に眠るための場所ではなくなります。'
          ]
        },
        {
          heading: 'ゲストが本当に気づく魅力',
          body: [
            'これは単なる宣伝文句ではありません。GoogleやAirbnbで実際にいただくレビューの中で最も頻繁に触れられる点のひとつであり、従来のホテルではなくIronwoodを選ぶ主な理由のひとつとして挙げられることがよくあります。出かける前にしっかりとした朝食で体験を仕上げたい方には、アパートメントから数メートルの提携施設で、ご要望に応じて有料の朝食サービスもご用意しています。'
          ]
        }
      ],
      highlights: [
        '専用の赤外線サウナとスチームバス、他の宿泊客とは共有しません',
        '予約不要、一日のどの時間帯でもご利用可能',
        'リビングルームには夜にぴったりの電気暖炉',
        'アパートメントから数メートルでご要望に応じた朝食'
      ],
  ...
  'livigno-estate': {
    ...
    da: {
      ...
      intro:
        'Hvad kan man helt konkret lave i Livigno om sommeren? Fra juni til september forvandles det alpine bassin til en af Europas mountainbike-hovedstæder, med stier til alle niveauer, en sø at udforske i kano eller til fods, og et bilfrit duty-free-centrum, der er værd at gå en tur i. Her er 10 uundgåelige oplevelser til kort at planlægge din sommer i Livigno.',
      sections: [
        {
          heading: '1–2. Mountainbike: Mottolino Bike Park og Bike Academy',
          body: [
            'Mottolino Bike Park er referencen for adrenalin, med 14 ruter inden for downhill, jumparea og north shore-sektioner. For familier eller dem, der cykler for første gang, tilbyder Bike Academy en rute på cirka 5 km, skræddersyet til begyndere.'
          ]
        },
        {
          heading: '3–4. Vandreture: Livigno-søen og de blomstrende alpeenge',
          body: [
            'Turen rundt om Livigno-søen er den enkleste og mest tilgængelige gåtur for alle, med masser af steder til en picnic. For dem, der søger en mere krævende vandretur, tilbyder stierne gennem de blomstrende alpeenge — arnika er egnens symbolblomst — udsigt over de Rætiske Alper.'
          ]
        },
        {
          heading: '5–6. Carosello 3000 om sommeren og en kanotur',
          body: [
            'Også vintersæsonens skilifte åbner om sommeren (cirka fra 20. juni til 13. september) og forbinder panoramastier i højden. På varmere dage egner søen sig også til en kanotur.'
          ]
        },
        {
          heading: '7–8. Duty-free-shopping og typiske retter fra Valtellina',
          body: [
            'Livignos bilfrie centrum, en told-frizone, er stadig et næsten obligatorisk stop for shopping. Prøv også de typiske retter fra Valtellina — pizzoccheri, sciatt og bresaola IGP — på byens restauranter, eller tilberedt i ro og mag i lejligheden.'
          ]
        },
        {
          heading: '9–10. Privat sauna efter sport og kølige temperaturer selv i august',
          body: [
            'Efter en dag med vandreture eller mountainbike hjælper den private infrarøde sauna og dampbadet med at løsne musklerne før middagen. Og sommertemperaturerne i Livigno forbliver kølige selv midt på sommeren — endnu en grund for dem, der søger lindring fra bykarmen.'
          ]
        }
      ],
      highlights: [
        'Over 50 km stier til mountainbike og vandreture',
        'Livigno-søen: gåtur, picnic eller kano',
        'Bilfrit duty-free-centrum, 15 minutters gang væk',
        'Privat sauna tilgængelig også efter sommersport'
      ],
      faq: [
        {
          q: 'Er Livigno et godt rejsemål, selv hvis man ikke dyrker mountainbike?',
          a: 'Ja: turen rundt om søen, de blomstrende alpeenge, duty-free-shopping og de typiske retter fra Valtellina er oplevelser tilgængelige for alle, uden krav om at være erfaren biker eller vandrer.'
        },
        {
          q: 'Hvornår er sommerliftene ved Carosello 3000 åbne?',
          a: 'Cirka fra 20. juni til 13. september, for at forbinde panoramastier i højden — de præcise datoer kan variere fra år til år.'
        },
        {
          q: 'Er det varmt i Livigno om sommeren?',
          a: 'Temperaturerne forbliver generelt kølige selv i august, en af grundene til at Livigno er populært blandt dem, der søger lindring fra bykarmen.'
        }
      ],
      internalLinkLabels: [
        'Læs den fulde guide til sommeren i Livigno hos Ironwood',
        'Læs den fulde artikel med alle detaljer',
        'Se aktiviteter, der også passer til børn'
      ],
      ctaText: 'Tjek ledighed for din sommer i Livigno',
      breadcrumbName: 'Livigno om sommeren',
      navLabel: 'Sommerhighlights',
      relatedLinkLabel: 'Læs også guiden om mountainbike, vandreture og søen'
    },
    pl: {
      ...
      intro:
        'Co konkretnie robić w Livigno latem? Od czerwca do września alpejska kotlina zamienia się w jedną ze stolic kolarstwa górskiego w Europie, z trasami dla każdego poziomu, jeziorem do odkrywania kajakiem lub pieszo oraz pieszym centrum bezcłowym wartym spaceru. Oto 10 niezapomnianych doświadczeń, w skrócie, do zaplanowania lata w Livigno.',
      sections: [
        {
          heading: '1–2. Rowery górskie: Mottolino Bike Park i Bike Academy',
          body: [
            'Mottolino Bike Park to punkt odniesienia dla adrenaliny, z 14 trasami obejmującymi downhill, strefę skoków i sekcje north shore. Dla rodzin lub początkujących rowerzystów Bike Academy oferuje trasę o długości około 5 km, zaprojektowaną specjalnie dla nowicjuszy.'
          ]
        },
        {
          heading: '3–4. Trekking: Jezioro Livigno i kwitnące hale',
          body: [
            'Trasa wokół Jeziora Livigno to najprostszy i dostępny dla wszystkich spacer, z licznymi miejscami na piknik. Dla tych, którzy szukają bardziej wymagającej wycieczki, szlaki przez kwitnące hale — arnika to symboliczny kwiat regionu — oferują widoki na Alpy Retyckie.'
          ]
        },
        {
          heading: '5–6. Carosello 3000 latem i wyprawa kajakiem',
          body: [
            'Wyciągi zimowego obszaru narciarskiego otwierają się także latem (orientacyjnie od 20 czerwca do 13 września), łącząc widokowe szlaki na wysokości. W cieplejsze dni jezioro nadaje się także na wyprawę kajakiem.'
          ]
        },
        {
          heading: '7–8. Zakupy bezcłowe i typowe dania z Valtelliny',
          body: [
            'Pieszy centrum Livigno, strefa wolnocłowa, pozostaje niemal obowiązkowym przystankiem na zakupy. Warto spróbować także typowych dań z Valtelliny — pizzoccheri, sciatt i bresaola IGP — w restauracjach miasteczka lub przygotowanych spokojnie w apartamencie.'
          ]
        },
        {
          heading: '9–10. Prywatna sauna po sporcie i chłodne temperatury nawet w sierpniu',
          body: [
            'Po dniu trekkingu lub jazdy na rowerze górskim prywatna sauna na podczerwień i łaźnia parowa pomagają rozluźnić mięśnie przed kolacją. A letnie temperatury w Livigno pozostają chłodne nawet w szczycie lata — kolejny powód dla szukających wytchnienia od miejskiego upału.'
          ]
        }
      ],
      highlights: [
        'Ponad 50 km szlaków dla rowerów górskich i trekkingu',
        'Jezioro Livigno: spacer, piknik lub kajak',
        'Pieszy centrum bezcłowe 15 minut spacerem',
        'Prywatna sauna dostępna także po letnim sporcie'
      ],
      faq: [
        {
          q: 'Czy Livigno to dobry kierunek również dla osób, które nie jeżdżą na rowerze górskim?',
          a: 'Tak: spacer wokół jeziora, kwitnące hale, zakupy bezcłowe i typowe dania z Valtelliny to doświadczenia dostępne dla każdego, nie wymagają bycia doświadczonym rowerzystą czy trekkerem.'
        },
        {
          q: 'Kiedy otwarte są letnie wyciągi Carosello 3000?',
          a: 'Orientacyjnie od 20 czerwca do 13 września, łącząc widokowe szlaki na wysokości — dokładne daty mogą się różnić w zależności od roku.'
        },
        {
          q: 'Czy w Livigno latem jest gorąco?',
          a: 'Temperatury pozostają na ogół chłodne nawet w sierpniu, co jest jednym z powodów, dla których Livigno jest doceniane przez szukających wytchnienia od miejskiego upału.'
        }
      ],
      internalLinkLabels: [
        'Przeczytaj pełny przewodnik po lecie w Livigno w Ironwood',
        'Przeczytaj pełny artykuł ze wszystkimi szczegółami',
        'Poznaj atrakcje odpowiednie także dla dzieci'
      ],
      ctaText: 'Sprawdź dostępność na swoje lato w Livigno',
      breadcrumbName: 'Livigno latem',
      navLabel: 'Podsumowanie lata',
      relatedLinkLabel: 'Przeczytaj także przewodnik o rowerach górskich, trekkingu i jeziorze'
    },
    cs: {
      ...
      intro:
        'Co konkrétně dělat v Livignu v létě? Od června do září se alpská kotlina mění v jednu z evropských hlavních destinací horské cyklistiky, s trasami pro každou úroveň, jezerem k objevování na kánoi nebo pěšky a pěší bezcelní zónou, kterou stojí za to projít. Zde je stručně 10 nezapomenutelných zážitků k naplánování vašeho léta v Livignu.',
      sections: [
        {
          heading: '1–2. Horská kola: Mottolino Bike Park a Bike Academy',
          body: [
            'Mottolino Bike Park je referenčním bodem pro adrenalin, se 14 trasami mezi downhillem, jump area a sekcemi north shore. Pro rodiny nebo začínající cyklisty nabízí Bike Academy trasu o délce přibližně 5 km, navrženou přímo pro nováčky.'
          ]
        },
        {
          heading: '3–4. Trekking: jezero Livigno a kvetoucí horské pastviny',
          body: [
            'Okruh kolem jezera Livigno je nejjednodušší a všem dostupnou procházkou, s řadou míst na piknik. Pro ty, kdo hledají náročnější výlet, nabízejí trasy kvetoucími horskými pastvinami — arnika je symbolickou květinou oblasti — výhledy na Rétské Alpy.'
          ]
        },
        {
          heading: '5–6. Carosello 3000 v létě a výlet na kánoi',
          body: [
            'V létě otevírají i vleky zimního lyžařského areálu (orientačně od 20. června do 13. září), které propojují panoramatické stezky ve výškách. V teplejších dnech se jezero hodí i na výlet na kánoi.'
          ]
        },
        {
          heading: '7–8. Bezcelní nákupy a typická jídla z Valtelliny',
          body: [
            'Pěší centrum Livigna, bezcelní zóna, zůstává téměř povinnou zastávkou na nákupy. Vyzkoušet stojí za to i typická jídla z Valtelliny — pizzoccheri, sciatt a bresaola IGP — v restauracích městečka nebo v klidu připravená v apartmánu.'
          ]
        },
        {
          heading: '9–10. Soukromá sauna po sportu a chladné teploty i v srpnu',
          body: [
            'Po dni tréninku nebo jízdy na horském kole pomáhají soukromá infrasauna a parní lázeň uvolnit svaly před večeří. A letní teploty v Livignu zůstávají příjemně chladné i v plném létě — další důvod pro ty, kdo hledají úlevu od městských veder.'
          ]
        }
      ],
      highlights: [
        'Přes 50 km tras pro horská kola a trekking',
        'Jezero Livigno: procházka, piknik nebo kánoe',
        'Pěší bezcelní centrum, 15 minut chůze',
        'Soukromá sauna dostupná i po letním sportu'
      ],
      faq: [
        {
          q: 'Je Livigno hodnotné i pro ty, kdo nejezdí na horském kole?',
          a: 'Ano: procházka kolem jezera, kvetoucí horské pastviny, bezcelní nákupy a typická jídla z Valtelliny jsou zážitky dostupné pro každého, nevyžadují být zkušeným bikerem nebo trekařem.'
        },
        {
          q: 'Kdy jsou otevřené letní vleky Carosello 3000?',
          a: 'Orientačně od 20. června do 13. září, k propojení panoramatických stezek ve výškách — přesná data se mohou rok od roku lišit.'
        },
        {
          q: 'Je v Livignu v létě horko?',
          a: 'Teploty zůstávají obecně příjemně chladné i v srpnu, což je jeden z důvodů, proč je Livigno oblíbené u těch, kdo hledají úlevu od městských veder.'
        }
      ],
      internalLinkLabels: [
        'Přečtěte si kompletního průvodce létem v Livignu u Ironwood',
        'Přečtěte si celý článek se všemi detaily',
        'Objevte aktivity vhodné i pro děti'
      ],
      ctaText: 'Ověřte dostupnost pro své léto v Livignu',
      breadcrumbName: 'Livigno v létě',
      navLabel: 'Léto v kostce',
      relatedLinkLabel: 'Přečtěte si také průvodce horskými koly, trekkingem a jezerem'
    },
    no: {
      ...
      eyebrow: 'Livigno om sommeren',
      intro:
        'Hva kan man konkret gjøre i Livigno om sommeren? Fra juni til september forvandles det alpine bassenget til en av Europas hovedsteder for fjellsykling, med stier for alle nivåer, en innsjø å utforske med kano eller til fots, og et bilfritt tollfritt sentrum verdt en spasertur. Her er 10 uforglemmelige opplevelser, kort fortalt, for å planlegge sommeren din i Livigno.',
      sections: [
        {
          heading: '1–2. Fjellsykling: Mottolino Bike Park og Bike Academy',
          body: [
            'Mottolino Bike Park er referansen for adrenalin, med 14 løyper innen downhill, hoppområde og north shore-seksjoner. For familier eller nybegynnere tilbyr Bike Academy en løype på omtrent 5 km, spesielt utformet for førstegangssyklister.'
          ]
        },
        {
          heading: '3–4. Fotturer: Livigno-sjøen og de blomstrende fjellbeitene',
          body: [
            'Runden rundt Livigno-sjøen er den enkleste og mest tilgjengelige turen for alle, med mange steder for en piknik. For dem som søker en mer krevende tur, tilbyr stiene gjennom de blomstrende fjellbeitene — arnika er egnens symbolblomst — utsikt over de Rætiske Alper.'
          ]
        },
        {
          heading: '5–6. Carosello 3000 om sommeren og en kanotur',
          body: [
            'Også heisene i vinterskiområdet åpner om sommeren (omtrent fra 20. juni til 13. september) og knytter sammen panoramastier i høyden. På varmere dager egner innsjøen seg også til en kanotur.'
          ]
        },
        {
          heading: '7–8. Tollfri shopping og typiske retter fra Valtellina',
          body: [
            'Livignos bilfrie sentrum, en tollfri sone, er fortsatt et nesten obligatorisk stopp for shopping. Verdt å prøve er også de typiske rettene fra Valtellina — pizzoccheri, sciatt og bresaola IGP — på byens restauranter, eller tilberedt i ro og mak i leiligheten.'
          ]
        },
        {
          heading: '9–10. Privat badstue etter sport og kjølige temperaturer selv i august',
          body: [
            'Etter en dag med fotturer eller fjellsykling hjelper den private infrarøde badstuen og dampbadet med å løsne musklene før middag. Og sommertemperaturene i Livigno forblir kjølige selv midt på sommeren — enda en grunn for dem som ønsker en pause fra byvarmen.'
          ]
        }
      ],
      highlights: [
        'Over 50 km stier for fjellsykling og fotturer',
        'Livigno-sjøen: tur, piknik eller kano',
        'Bilfritt tollfritt sentrum, 15 minutters gange unna',
        'Privat badstue tilgjengelig også etter sommersport'
      ],
      faq: [
        {
          q: 'Er Livigno et bra reisemål selv for dem som ikke driver med fjellsykling?',
          a: 'Ja: turen rundt innsjøen, de blomstrende fjellbeitene, tollfri shopping og typiske retter fra Valtellina er opplevelser tilgjengelige for alle, det kreves ikke å være en erfaren syklist eller turgåer.'
        },
        {
          q: 'Når er sommerheisene ved Carosello 3000 åpne?',
          a: 'Omtrent fra 20. juni til 13. september, for å knytte sammen panoramastier i høyden — de eksakte datoene kan variere fra år til år.'
        },
        {
          q: 'Er det varmt i Livigno om sommeren?',
          a: 'Temperaturene forblir generelt kjølige selv i august, en av grunnene til at Livigno er populært blant dem som ønsker en pause fra byvarmen.'
        }
      ],
      internalLinkLabels: [
        'Les den fullstendige guiden til sommeren i Livigno hos Ironwood',
        'Les hele artikkelen med alle detaljer',
        'Oppdag aktiviteter som også passer for barn'
      ],
      ctaText: 'Sjekk tilgjengelighet for din sommer i Livigno',
      breadcrumbName: 'Livigno om sommeren',
      navLabel: 'Sommerhøydepunkter',
      relatedLinkLabel: 'Les også guiden om fjellsykling, fotturer og innsjøen'
    },
    nl: {
      ...
      intro:
        'Wat kun je in de praktijk doen in Livigno in de zomer? Van juni tot september verandert dit alpendal in een van de mountainbikehoofdsteden van Europa, met paden voor elk niveau, een meer om te ontdekken per kano of te voet, en een autovrij duty-free centrum dat een wandeling waard is. Hier zijn, kort samengevat, 10 onmisbare ervaringen om jouw zomer in Livigno te plannen.',
      sections: [
        {
          heading: '1–2. Mountainbiken: Mottolino Bike Park en de Bike Academy',
          body: [
            'Mottolino Bike Park is hét referentiepunt voor adrenaline, met 14 routes tussen downhill, een jumparea en north-shoresecties. Voor gezinnen of beginnende fietsers biedt de Bike Academy een route van ongeveer 5 km, speciaal ontworpen voor starters.'
          ]
        },
        {
          heading: '3–4. Wandelen: het Meer van Livigno en de bloeiende alpenweiden',
          body: [
            'De rondje rond het Meer van Livigno is de eenvoudigste en voor iedereen toegankelijke wandeling, met veel plekjes voor een picknick. Voor wie een pittigere tocht zoekt, bieden de paden door de bloeiende alpenweiden — de arnica is de symboolbloem van de streek — uitzicht op de Rätische Alpen.'
          ]
        },
        {
          heading: '5–6. Carosello 3000 in de zomer en een kanotocht',
          body: [
            "Ook de liften van het winterse skigebied gaan 's zomers open (ongeveer van 20 juni tot 13 september) en verbinden panoramische paden op hoogte. Op warmere dagen leent het meer zich ook voor een kanotocht."
          ]
        },
        {
          heading: '7–8. Duty-free shoppen en typische gerechten uit de Valtellina',
          body: [
            'Het autovrije centrum van Livigno, een duty-free douanezone, blijft een bijna verplichte stop om te shoppen. Ook de moeite waard: de typische gerechten uit de Valtellina — pizzoccheri, sciatt en bresaola IGP — in de restaurants van het dorp of rustig bereid in het appartement.'
          ]
        },
        {
          heading: '9–10. Privésauna na de sport en koele temperaturen zelfs in augustus',
          body: [
            'Na een dag wandelen of mountainbiken helpen de privé infraroodsauna en het stoombad om de spieren te ontspannen voor het avondeten. En de zomertemperaturen in Livigno blijven ook midden in de zomer koel — nog een reden voor wie de stadshitte wil ontvluchten.'
          ]
        }
      ],
      highlights: [
        'Meer dan 50 km paden voor mountainbiken en wandelen',
        'Meer van Livigno: wandeling, picknick of kano',
        'Autovrij duty-free centrum, 15 minuten lopen',
        'Privésauna ook beschikbaar na de zomersport'
      ],
      faq: [
        {
          q: 'Is Livigno ook de moeite waard voor wie niet aan mountainbiken doet?',
          a: 'Ja: de wandeling rond het meer, de bloeiende alpenweiden, duty-free shoppen en de typische gerechten uit de Valtellina zijn ervaringen die voor iedereen toegankelijk zijn, je hoeft geen ervaren fietser of wandelaar te zijn.'
        },
        {
          q: 'Wanneer zijn de zomerliften van Carosello 3000 open?',
          a: 'Ongeveer van 20 juni tot 13 september, om panoramische paden op hoogte te verbinden — de exacte data kunnen van jaar tot jaar variëren.'
        },
        {
          q: 'Is het warm in Livigno in de zomer?',
          a: 'De temperaturen blijven over het algemeen koel, zelfs in augustus, een van de redenen waarom Livigno populair is bij wie de stadshitte wil ontvluchten.'
        }
      ],
      internalLinkLabels: [
        'Lees de volledige gids over de zomer in Livigno bij Ironwood',
        'Lees het volledige artikel met alle details',
        'Ontdek activiteiten die ook geschikt zijn voor kinderen'
      ],
      ctaText: 'Check de beschikbaarheid voor jouw zomer in Livigno',
      breadcrumbName: 'Livigno in de zomer',
      navLabel: 'Zomerhoogtepunten',
      relatedLinkLabel: 'Lees ook de gids over mountainbiken, wandelen en het meer'
    },
    zh: {
      title: '利维尼奥夏季活动指南:10项不容错过的体验',
      metaTitle: '利维尼奥的夏天 | 10件必做的事:骑行、徒步与湖泊',
      metaDescription: '山地自行车、徒步、利维尼奥湖以及运动后的私人桑拿:精心整理的10项不容错过的体验,助您规划完美的利维尼奥夏日之旅。',
      eyebrow: '利维尼奥的夏天',
      intro:
        '在利维尼奥的夏天究竟能做些什么?从6月到9月,这片阿尔卑斯山谷会变身为欧洲最热门的山地自行车胜地之一,拥有适合各个水平的步道、可乘独木舟或徒步探索的湖泊,以及值得漫步的免税步行街区。以下为您简要列出10项不容错过的体验,助您规划利维尼奥的夏日之旅。',
      sections: [
        {
          heading: '1–2. 山地自行车:Mottolino自行车公园与自行车学院',
          body: [
            'Mottolino自行车公园是追求肾上腺素飙升的首选之地,拥有14条赛道,涵盖速降、跳跃区和North Shore路段。对于带孩子出行的家庭或初次骑行者,自行车学院提供一条约5公里、专为新手设计的路线。'
          ]
        },
        {
          heading: '3–4. 徒步:利维尼奥湖与鲜花盛开的高山牧场',
          body: [
            '环绕利维尼奥湖的步道是最简单、人人皆宜的散步路线,沿途有许多适合野餐的地点。若想尝试更具挑战性的徒步路线,穿越鲜花盛开的高山牧场的步道——山金车是当地的象征之花——可以欣赏到雷蒂克阿尔卑斯山脉的景色。'
          ]
        },
        {
          heading: '5–6. 夏季的Carosello 3000与独木舟之旅',
          body: [
            '冬季滑雪区的缆车在夏季也会开放(大致时间为6月20日至9月13日),串联起高海拔的观景步道。天气较热的日子里,湖泊也很适合划独木舟。'
          ]
        },
        {
          heading: '7–8. 免税购物与瓦尔泰利纳特色美食',
          body: [
            '利维尼奥的免税步行街区几乎是购物的必去之地。此外,瓦尔泰利纳的特色美食——荞麦面(pizzoccheri)、炸奶酪饺(sciatt)和IGP风干牛肉(bresaola)——同样值得一试,无论是在镇上的餐厅品尝,还是在公寓里悠闲烹饪。'
          ]
        },
        {
          heading: '9–10. 运动后的私人桑拿与8月依旧凉爽的气温',
          body: [
            '徒步或山地自行车一天之后,私人红外线桑拿和土耳其蒸汽浴有助于在晚餐前舒展肌肉。而利维尼奥的夏季气温即使在盛夏也保持凉爽——这也是渴望逃离城市酷暑的旅行者的又一个理由。'
          ]
        }
      ],
      highlights: [
      ...
      faq: [
        {
          q: '对于不骑山地自行车的人来说,利维尼奥也值得一游吗?',
          a: '当然:环湖步道、鲜花盛开的高山牧场、免税购物以及瓦尔泰利纳特色美食都是人人皆宜的体验,无需成为经验丰富的骑手或徒步者。'
        },
        {
          q: 'Carosello 3000的夏季缆车何时开放?',
          a: '大致时间为6月20日至9月13日,用于串联高海拔的观景步道——具体日期可能因年份而异。'
        },
        {
          q: '利维尼奥的夏天炎热吗?',
          a: '即使在8月,气温通常也保持凉爽,这也是利维尼奥深受渴望逃离城市酷暑的旅行者青睐的原因之一。'
        }
      ],
      internalLinkLabels: [
        '阅读Ironwood利维尼奥夏季完整指南',
        '阅读包含所有细节的完整文章',
        '了解适合儿童的活动'
      ],
      ctaText: '查询您在利维尼奥夏季的入住空房情况',
      breadcrumbName: '利维尼奥的夏天',
      navLabel: '夏日精选',
      relatedLinkLabel: '同时阅读山地自行车、徒步与湖泊指南'
    },
    ja: {
      title: 'リヴィニョの夏の楽しみ方:見逃せない10の体験',
      metaTitle: 'リヴィニョの夏 | やるべき10のこと:バイク、トレッキング、湖',
      metaDescription: 'マウンテンバイク、トレッキング、リヴィニョ湖、そしてスポーツの後の専用サウナ。リヴィニョの夏を計画するための、見逃せない10の体験をご紹介します。',
      eyebrow: 'リヴィニョの夏',
      intro:
        '実際にリヴィニョの夏には何ができるのでしょうか。6月から9月にかけて、このアルプスの盆地はヨーロッパ屈指のマウンテンバイクの聖地へと姿を変え、あらゆるレベルに対応するトレイル、カヌーや徒歩で楽しめる湖、そして散策にぴったりの免税歩行者エリアが揃います。リヴィニョの夏を計画するための、見逃せない10の体験を簡潔にご紹介します。',
      sections: [
        {
          heading: '1–2. マウンテンバイク:Mottolino Bike ParkとBike Academy',
          body: [
            'アドレナリンを求める人の定番はMottolino Bike Parkで、ダウンヒル、ジャンプエリア、ノースショアセクションを含む14のコースがあります。ご家族連れや初めてバイクに乗る方には、Bike Academyが初心者向けに設計された約5kmのコースを提供しています。'
          ]
        },
        {
          heading: '3–4. トレッキング:リヴィニョ湖と花咲く高山牧場',
          body: [
            'リヴィニョ湖を一周するコースは最もシンプルで誰でも楽しめる散策路で、ピクニックに適したスポットも点在しています。より本格的なハイキングをお求めの方には、花咲く高山牧場——アルニカはこの地域を象徴する花です——を抜けるトレイルが、レティッシュアルプスの景色を楽しませてくれます。'
          ]
        },
        {
          heading: '5–6. 夏のCarosello 3000とカヌー体験',
          body: [
            '冬のスキーエリアのリフトも夏には開放され(目安として6月20日から9月13日頃まで)、標高の高いパノラマトレイルをつないでいます。気温の高い日には、湖でのカヌー体験もおすすめです。'
          ]
        },
        {
          heading: '7–8. 免税ショッピングとヴァルテッリーナの郷土料理',
          body: [
            'リヴィニョの免税歩行者エリアは、関税免除地域であり、ショッピングにはほぼ欠かせないスポットです。ヴァルテッリーナの郷土料理——ピッツォッケリ、シャット、IGP認証のブレザオーラ——も、町のレストランで、あるいはアパートメントでゆっくり調理して味わう価値があります。'
          ]
        },
        {
          heading: '9–10. スポーツ後の専用サウナと8月でも涼しい気温',
          body: [
            'トレッキングやマウンテンバイクを楽しんだ一日の後は、専用の赤外線サウナとスチームバスが夕食前に筋肉をほぐす助けとなります。そしてリヴィニョの夏の気温は、真夏でも涼しさを保っています。都会の暑さから逃れたい方にはさらなる理由となるでしょう。'
          ]
        }
      ],
      highlights: [
        'マウンテンバイクとトレッキングのための50km以上のトレイル',
        'リヴィニョ湖:散策、ピクニック、カヌー',
        '徒歩15分の免税歩行者エリア',
        '夏のスポーツの後にも利用できる専用サウナ'
      ],
      faq: [
        {
          q: 'マウンテンバイクをしない人でもリヴィニョは楽しめますか?',
          a: 'はい。湖畔の散策、花咲く高山牧場、免税ショッピング、ヴァルテッリーナの郷土料理は、誰でも楽しめる体験で、経験豊富なバイカーやハイカーである必要はありません。'
        },
        {
          q: 'Carosello 3000の夏季リフトはいつ開いていますか?',
          a: '目安として6月20日から9月13日頃までで、標高の高いパノラマトレイルをつないでいます。正確な日程は年によって異なる場合があります。'
        },
        {
          q: 'リヴィニョの夏は暑いですか?',
          a: '8月でも気温は概ね涼しく保たれており、これも都会の暑さから逃れたい人々にリヴィニョが好まれる理由のひとつです。'
        }
      ],
      internalLinkLabels: [
        'Ironwoodでのリヴィニョ夏の完全ガイドをお読みください',
        'すべての詳細を含む完全な記事をお読みください',
        'お子様にも適したアクティビティをご覧ください'
      ],
      ctaText: 'リヴィニョでの夏のご滞在、空室状況を確認する',
      breadcrumbName: 'リヴィニョの夏',
      navLabel: '夏のハイライト',
      relatedLinkLabel: 'マウンテンバイク、トレッキング、湖のガイドもあわせてお読みください'
    }
  }
};
